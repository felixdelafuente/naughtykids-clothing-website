...
<body>
  ...
  <div class="container-fluid shop-container">
    ...
    <div class="row search-row">
        <form class="search-group" action="searchproduct.php" method="POST">
          <input type="text" name="search-box" placeholder="Search" class="search-box">
          <button id="search-btn" type="submit" name="search" class="btn btn-primary admin-sign-in" data-bs-toggle="modal" data-bs-target="#searchModal">
